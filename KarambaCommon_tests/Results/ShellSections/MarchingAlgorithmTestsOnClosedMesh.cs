...
namespace KarambaCommon.Tests.Result.ShellSection
{
    ...
    [TestFixture]
    public class MarchingAlgorithmTestsOnClosedMesh
    {
        [OneTimeSetUp]
        public void Initialize()
        {
            ...
            List<Karamba.Elements.BuilderShell> shells = k3d.Part.MeshToShell(
                ...
                logger,
                out _);
            Karamba.Models.Model model = k3d.Model.AssembleModel(shells, supports, loads, out _, out _, out _, out _, out _);
            model = k3d.Algorithms.AnalyzeThI(model, out _, out _, out _, out _);

            // Create projection Vector
            var projectionVector = new Vector3(0, 1, 0);
            ...
            List<int> expectedFaceIndices)
        {
            ...
            retriever.FindSection(out var outputPolylines, out var outputCrossedFaces, out _);

            Assert.That(outputPolylines[0], Is.EqualTo(expectedPolyline).Using<PolyLine3>(EqualityWithTol));
            Assert.That(outputCrossedFaces[0], Is.EqualTo(expectedFaceIndices).Within(_tol));
        }
        ...
        public void FindSection_2pt_polyline_start_and_end_not_project_on_mesh()
        {
            ...
            var expectedFaceIndices = new List<int>
            {
                19,
                3,
                22,
            ...
            MakeComparison(inputPolyline, expectedPolyline, expectedFaceIndices);
        }
        ...
        public void FindSection_2pt_polyline_start_and_end_project_on_mesh()
        {
            ...
            var expectedFaceIndices = new List<int>() { 18, 2, 19, 3, };
        ...
        private void FindSection_2pt_polyline_start_project_on_vertex_with_next_prev_march_direction_equal_edges()
        {
            var inputPolyline = new PolyLine3
            {
                new Point3(-1, -1, 1),
        ...
        public void FindSection_2pt_polyline_startPtProjectOnVertex_endPtProjectOutside()
        {
            ...
            var expectedFaceIndices = new List<int>() { 2, 5, 23, 7, 26, 10, };
        ...
        {
            var inputPolyline = new PolyLine3 { new Point3(1, -1, 1), new Point3(2.5, -1, 1) };
            var expectedPolyline = new PolyLine3
            {
                new Point3(1, 0, 1),
                new Point3(1, 0, 1),
            ...
            var expectedFaceIndices = new List<int>() { 2, 5, 7, 10, };
