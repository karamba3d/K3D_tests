...
namespace KarambaCommon.Tests.Model
{
    ...
    public class ExportModel_tests
    {
        ...
        public void ExportToDAStV()
        {
            ...
            crosec.setMaterial(k3d.Material.IsotropicMaterial("family", "name", 21000.1111, 8750.123,
                8750.123, 234.234567, 2.34566, -10.3,FemMaterial.FlowHypothesis.mises, 1.23456e-6));
            ...
            var res = builder.getProduct().ToString().Split(
                new[] { "\r\n", "\r", "\n" },
                StringSplitOptions.None
            );

            var comp = res[11] == "#5=MATERIAL($,'name',21.0001111,8.750123,0.000234234567,1.23456E-06,0.00234566,$,$,$);";
            Assert.IsTrue(comp);
