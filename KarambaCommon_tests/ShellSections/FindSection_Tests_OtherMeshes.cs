...
namespace KarambaCommon.Tests.Result.ShellSection
{
    ...
    public class RetrieverFindSection_Tests_NonConvexMesh
    {
        ...
        public void FindSection_3ptPolyline_NonConvexMesh()
        {
            ...
            PolyLine3 inputPolyline = new PolyLine3(new Point3(0.5, -0.5, 1), new Point3(0.5, 0.8, 1), new Point3(0.5, 3.5, 1));
            Vector3 inputProjectionVector = new Vector3(0, 0, -1);
            var inputModel = MakeNonConvexModel();
            var tol = 1E-12;
            var delta = 0.02;
            var info = new RetrieverInfo_Force(inputModel, inputPolyline, inputProjectionVector, tol, delta, "0");  
            ...
            var expectedFaceIndxs = new List<List<int>>()
            {
                new List<int>(){0},
                new List<int>(){1,2}
            };
    ...
    [TestFixture]
    class RetrieverFindSection_Tests_NonPlanarMesh
    {
        private double _tol;
