...
namespace KarambaCommon.Tests.Result.ShellSection
{
    ...
    public class RetrieverFindSection_Tests_OnClosedMesh
    {
        ...
        public void FindSection_2pt_polyline_start_and_end_not_project_on_mesh()
        {
            ...
            var exp_faces = new List<int>() { 19, 3, 22, 6, 24, 8, 25, 9, 28, 12, 18, 2 };
        ...
        public void FindSection_2pt_polyline_just_start_project_on_mesh()
        {
            ...
            var exp_faces = new List<int>() { 9, 25, 8, 24, 6, 22, 3, 19, 2, 18 };
            exp_poly.Reverse();
            exp_faces.Reverse();
        ...
        public void FindSection_2pt_polyline_just_end_project_on_mesh()
        {
            ...
            var exp_faces = new List<int>() { 24, 8, 25, 9, 28, 12, 18, 2, 19, 3 };

            MakeComparison(in_poly, exp_poly, exp_faces);
        }

        [Test, Description("Test_4: 2pt polyline: starting point on edge")]
        ...
        [Test, Description("Test_6: 2pt polyline: starting point on vertex, start outside, end outside n")]
        public void FindSection_2pt_polyline_startPt_endPt_project_outside_and_startingPt_project_on_vertex()
        {
            ...
            var exp_faces = new List<int>() { 11, 29, 13, 20, 4, 2, 19, 3, 22, 6, 24 };

            MakeComparison(in_poly, exp_poly, exp_faces);
        }

        [Test, Description("Test_7: 2pt polyline: start on edge, end outside")]
        ...
        [Test, Description("Test_8: 2pt polyline: start on vertex, end outside")]
        ...
        [Test, Description("Test_9: 2pt polyline: start on edge, next direction march = edges direction")]
        ...
        [Test, Description("Test_10: 2pt polyline: start on vertex, next direction march = edges direction")]
        ...
        public void FindSection_3PtPolyline_startPtOutside_middlePtProject_endPtOutside()
        {
            ...
            var exp_faces = new List<int>() { 2, 16, 0, 9, 25, 25, 9, 28, 12, 18, 2 };

            MakeComparison(in_poly, exp_poly, exp_faces);
        }

        [Test, Description("Test_12: 3pt polyline: middle on edge, next and prev march no cross projection face")]
        public void FindSection_3PtPolyline_middlePtProjectOnEdge_projectionFaceNotCrossed()
        {
            var in_poly = MakeNewPolyline
            (
                new Point3(2.5, -1, 0.8),
                new Point3(1, -1, 0.5),
                new Point3(2, -1, -1)
            );
            var exp_poly = MakeNewPolyline
            ...
            var exp_faces = new List<int>() { 2, 19, 3, 17, 1, 8, 8, 24, 6, 22, 3, 19 };

            MakeComparison(in_poly, exp_poly, exp_faces);
        }

        [Test, Description("Test_13: 3pt polyline: middle on edge, next march cross proj face, prev march no cross projection face")]
        public void FindSection_3PtPolyline_middlePtProjectOnEdge_projectionFaceCrossedInNextDirection()
        {
            ...
            var exp_faces = new List<int>() { 2, 16, 0, 9, 25, 25, 8, 24, 6, 22, 3, 19 };

            MakeComparison(in_poly, exp_poly, exp_faces);
        }

        [Test, Description("Test_14: 3pt polyline: middle on edge, next and prev march cross projection face")]
        public void FindSection_3PtPolyline_middlePtProjectOnEdge_projectionFaceCrossedBothDirection()
        {
            ...
            var exp_faces = new List<int>() { 2, 16, 0, 9, 25, 25, 9, 0, 16, 2 };

            MakeComparison(in_poly, exp_poly, exp_faces);
        }

        [Test, Description("Test_15: 3pt polyline: middle on vertex, next and prev march no cross projection face")]
        ...
        [Test, Description("Test_16: 3pt polyline: middle on vertex, next march cross proj face, prev march no cross projection face")]
        public void FindSection_3PtPolyline_middlePtProjectOnVertex_projectionFaceCrossedInNextDirection()
        {
            ...
            var exp_faces = new List<int>() { 2, 16, 0, 9, 25, 25, 24, 6, 22, 3, 19 };

            MakeComparison(in_poly, exp_poly, exp_faces);
        }

        [Test, Description("Test_17: 3pt polyline: middle on vertex, next and prev march cross projection face")]
        ...
        [Test, Description("Test_18: 3pt polyline: middle on edge, next march = edges direction")]
        public void FindSection_3PtPolyline_middlePtProjectOnEdge_NextMarchDirectionEqualsEdgeDirection()
        {
            ...
            var exp_faces = new List<int>() { 2, 4, 14, 10, 8, 8, 25, 9, 0, 16, 2 };

            MakeComparison(in_poly, exp_poly, exp_faces);
        }

        [Test, Description("Test_19: 3pt polyline: middle on edge, prev march = edges direction")]
        public void FindSection_3PtPolyline_middlePtProjectOnEdge_PrevMarchDirectionEqualsEdgeDirection()
        {
            ...
            var exp_faces = new List<int>() { 2, 16, 0, 9, 25, 25, 10, 14, 4, 2 };

            MakeComparison(in_poly, exp_poly, exp_faces);
        }

        [Test, Description("Test_20: 3pt polyline: middle on edge, next and prev march = edges direction")]
        ...
        [Test, Description("Test_21: 3pt polyline: middle on vertex, next and prev march = edges direction, next cross projection face")]
        public void FindSection_3PtPolyline_middlePtProjectOnEdge_PrevNextMarchDirectionEqualsEdgeDirection_ProjectionFaceCrossedInNextDir()
        {
            var in_poly = MakeNewPolyline
        ...
        [Test, Description("Test_22: 3pt polyline: middle on vertex, next and prev march = edges direction, no cross projection face")]
        public void FindSection_3PtPolyline_middlePtProjectOnEdge_PrevNextMarchDirectionEqualsEdgeDirection_ProjectionFaceNotCrossed()
        {
            var in_poly = MakeNewPolyline
            (
                new Point3(3, -1, 3),
