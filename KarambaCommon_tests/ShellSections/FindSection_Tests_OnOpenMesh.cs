...
namespace KarambaCommon.Tests.Result.ShellSection
{
    ...
    public class RetrieverFindSection_Tests_OnOpenMesh
    {
        ...
        [Test, Description("Test_0: 2pt polyline")]
        ...
        [Test, Description("Test_1: 2pt polyline: start project, end project")]
        ...
        [Test, Description("Test_2: 2pt polyline: start project, end outside")]
        ...
        [Test, Description("Test_3: 2pt polyline: start outside, end project")]
        ...
        [Test, Description("Test_4: 2pt polyline: start on vertex, end project in the same face as start")]
        ...
        [Test, Description("Test_5: 2pt polyline: start on vertex, end project in different face compared to start")]
        ...
        [Test, Description("Test_6: 2pt polyline: start on edge, end project in the same face as start")]
        ...
        [Test, Description("Test_7: 2pt polyline: start on edge, end project in different face compared to start")]
        ...
        [Test, Description("Test_8: 2pt polyline: start on vertex, end on vertex in the same face as start")]
        ...
        [Test, Description("Test_9: 2pt polyline: start on vertex, end on vertex in different face compared to start")]
        ...
        [Test, Description("Test_10: 3pt polyline: start project, middle project, end project")]
        ...
        [Test, Description("Test_11: 3pt polyline: start outside, middle project, end outside")]
        ...
        [Test, Description("Test_12: 3pt polyline: middle on vertex, start project in same face, end project in same face")]
        public void FindSection_for_3pt_polyline_middle_pt_project_on_mesh_vertex_start_and_end_projecting_into_same_face()
        {
            var polylineToProject = MakeNewPolyline
            (
                new Point3(0, -0.5, 1),
        ...
        [Test, Description("Test_13: 3pt polyline: middle on vertex, start project on different face, end project on different face")]
        public void FindSection_for_3pt_polyline_middle_pt_project_on_mesh_vertex_start_end_and_middle_projecting_into_different_faces()
        {
            var polylineToProject = MakeNewPolyline
            (
        ...
        [Test, Description("Test_14: 3pt polyline: middle on vertex, start project in same face, end project in different")]
        public void FindSection_for_3pt_polyline_middle_pt_project_on_mesh_vertex_start_and_middle_projecting_into_same_faces()
        {
            var polylineToProject = MakeNewPolyline
            (
                new Point3(0, -0.5, 1),
        ...
        [Test, Description("Test_15: 3pt polyline: middle on edge, start project in same face, end project in same face")]
        public void FindSection_for_3pt_polyline_middle_pt_project_on_mesh_edge_start_end_and_middle_projecting_into_same_face()
        {
            var polylineToProject = MakeNewPolyline
            (
                new Point3(0, -0.5, 1),
        ...
        [Test, Description("Test_16: 3pt polyline: middle on edge, start project on different face, end project on different face")]
        public void FindSection_for_3pt_polyline_middle_pt_project_on_mesh_edge_start_end_and_middle_projecting_into_different_faces()
        {
            var polylineToProject = MakeNewPolyline
            (
                new Point3(-0.2, 0.5, 1),
        ...
        [Test, Description("Test_17: 3pt polyline: middle on edge, start project in same face, end project in different")]
        ...
        public void FindSection_for_3pt_polyline_middle_pt_project_on_vertex_and_next_direction_marching_equal_edges_direction()
        {
            var polylineToProject = MakeNewPolyline
            (
                new Point3(-1, 3, 1),
        ...
        public void FindSection_for_3pt_polyline_middle_pt_project_on_vertex_and_prev_direction_marching_equal_edges_direction()
        {
            var polylineToProject = MakeNewPolyline
            (
                new Point3(1, -1, 1),
        ...
        public void FindSection_for_3pt_polyline_middle_pt_project_on_vertex_and_both_next_and_prev_direction_marching_equal_edges_direction()
        {
            var polylineToProject = MakeNewPolyline
            (
                new Point3(1, -1, 1),
        ...
        public void FindSection_for_3pt_polyline_middle_pt_project_on_edge_and_next_direction_marching_equal_edges_direction()
        {
            var polylineToProject = MakeNewPolyline
            (
                new Point3(-1, 3.5, 1),
        ...
        public void FindSection_for_3pt_polyline_middle_pt_project_on_edge_and_prev_direction_marching_equal_edges_direction()
        {
            var polylineToProject = MakeNewPolyline
            (
                new Point3(1, -1, 1),
        ...
        public void FindSection_for_3pt_polyline_middle_pt_project_on_edge_and_both_next_and_prev_direction_marching_equal_edges_direction()
        {
            var polylineToProject = MakeNewPolyline
            (
                new Point3(1, -1, 1),
